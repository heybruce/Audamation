...
public class ModifySparePartsJPTest extends TestBase {
    ...
    public void manuallyAddParts() {
        ...
        Assert.assertEquals(modifySparePartsPO.getPartType(0), testData.getString("PartType_OEM"));
    ...
    public void modifyThePriceLessThanOriginalPrice() throws InterruptedException {
        //Launch browser
        getDriver().get(testData.getString("test_url"));
        testCase.get().log(Status.INFO, "Browser launched successfully");
    ...
    public void addPartsByUploadingCSV() throws URISyntaxException {
        ...
        File csvTemplate = new File(ModifySparePartsJPTest.class.getClassLoader().getResource("template/PartsUploaderTest_JP.csv").toURI());
        ...
        String PartNumberExpected = testData.getString("CSV_PartNumber").replaceAll(" ","");
        String PartPriceExpected = Integer.toString(csvUnitPrice*csvAmount);
        ...
        Assert.assertEquals(modifySparePartsPO.getEnteredPrice(0).replaceAll("\\pP",""), PartPriceExpected);
