...
public class AttachmentSGTest extends TestBase {
    ...
    public void uploadPDFFile() throws URISyntaxException {
        ...
        // Get test file path
        File pdf_file = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/PrintPdf.pdf").toURI());
    ...
    public void uploadWordDocFile() throws URISyntaxException {
        ...
        // Get test file path
        File doc_file = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/doc.doc").toURI());
    ...
    public void uploadWordDocxFile() throws URISyntaxException {
        ...
        // Get test file path
        File docx_file = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/docx.docx").toURI());
    ...
    public void uploadExcelXlsFile() throws URISyntaxException {
        ...
        // Get test file path
        File xls_file = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/xls.xls").toURI());
    ...
    public void uploadExcelXlsxFile() throws URISyntaxException {
        ...
        // Get test file path
        File xlsx_file = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/xlsx.xlsx").toURI());
    ...
    public void uploadTextTxtFile() throws URISyntaxException {
        ...
        // Get test file path
        File txt_file = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/textFile.txt").toURI());
    ...
    public void renameAttachment() throws URISyntaxException {
        ...
        File claimDocumentFile = new File(AttachmentSGTest.class.getClassLoader().getResource("images/"+claimDocumentFileName).toURI());
        ...
        File vehicleBeforeRepairFile = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/"+vehicleBeforeRepairFileName).toURI());
        ...
        File vehicleAfterRepairFile = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/"+vehicleAfterRepairFileName).toURI());
        ...
        File otherFile = new File(AttachmentSGTest.class.getClassLoader().getResource("attachments/"+otherFileName).toURI());
