...
public class WorkListOpenBoxIDTest extends TestBase {
    ...
    public void changeOwnerInOpenBox() {
        ...
        worklistTaskActions.changeOwnerTo(displayName, newOwner);

        //Check the claim is not in open box
        workListGridOpenPO.clickCustomOpenTab();
        workListGridOpenPO.sortCreationDate();
        Assert.assertFalse(workListGridOpenPO.isRepairReferenceNumberExist(displayName));
        ...
        workListGridOpenPO.sortCreationDate();
        Assert.assertTrue(workListGridOpenPO.isRepairReferenceNumberExist(displayName));
    ...
    public void closeTheTaskInOpenBox(){
        ...
        workListGridOpenPO.sortCreationDate();
        WorklistTaskActions worklistTaskActions = new WorklistTaskActions();
        worklistTaskActions.closeTheTask(displayName);
    ...
    public void sendCaseWithAllCalculations() throws URISyntaxException, InterruptedException {
        //Launch browser
        getDriver().get(testData.getString("test_url"));
        testCase.get().log(Status.INFO, "Browser launched successfully");
    ...
    public void submitCaseWithSelectedAttachments() throws URISyntaxException, InterruptedException {
        //Launch browser
        getDriver().get(testData.getString("test_url"));
        testCase.get().log(Status.INFO, "Browser launched successfully");
    ...
    public void acceptEstimateFromWorkList() throws URISyntaxException, InterruptedException {
        //Launch browser
        getDriver().get(testData.getString("test_url"));
        testCase.get().log(Status.INFO, "Browser launched successfully");
        ...
        String claimNumber = "";
        CreateNewCaseID createNewCase = new CreateNewCaseID();
        claimNumber = createNewCase.createCaseWithPendingAgreementStatus(testData.getString("benzS_vehicle"), true, insurer);
    ...
    public void rejectEstimateFromWorkList() throws URISyntaxException, InterruptedException {
        //Launch browser
        getDriver().get(testData.getString("test_url"));
        testCase.get().log(Status.INFO, "Browser launched successfully");
